...
enum{
	Uart0		= 0xE000C000,	/* COM1 */
	Uart0IRQ	= 4,
	Uart1		= 0xE0010000,	/* COM2 */
	Uart1IRQ	= 3,

	UartFREQ	= 30000000,	// this is PCLK
};
...
enum{
	...
	Dlm		= 4,		/* Divisor Latch High Byte (RW) */
	Ier		= 4, 		/* Interrupt Enable Register (RW) */
	Iir		= 8,		/* Interrupt Identification Register (RO) */
	Fcr		= 8, 		/* FIFO Control Register (WO) */
	Lcr		= 12,		/* Line Control Register (RW) */
	Mcr		= 16,		/* Modem Control Register (RW) */
	Lsr		= 20,		/* Line Status Register (RO) */
	Msr		= 24,		/* Modem Status Register (RO) */
	Scr		= 28,		/* Scratch Pad Register (RW) */
	
	Ter		= 48,		/* Transmit enable register */
};
